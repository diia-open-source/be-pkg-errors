 ...
 *
 * External: used for errors like an outage or timeouts caused by external registries or systems, so the internal team can't fix it alone. "Not Found" errors for resources are usually not External errors.
 *
