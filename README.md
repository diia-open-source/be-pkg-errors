...
This repository contains the package with common errors for backend services.
...
In order to install and use the linked dependencies for `pkg-errors` the following command can be used:
